...
pub(crate) fn console_context() -> ContextMenu {
    ContextMenu::new(vec![
...
pub(crate) fn graphics_context() -> ContextMenu {
    ContextMenu::new(vec![
