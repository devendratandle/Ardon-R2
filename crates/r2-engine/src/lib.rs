...
impl Engine {
    ...
    pub fn new() -> Self {
        ...
        e.registry.add_layer(mkpkg("stats", PackageTier::Base, vec![
            ...
            // ML functions
            ("svd",bi_svd),("eigen",bi_eigen),("prcomp",bi_prcomp),("solve",bi_solve),("det",bi_det),("mmap.write",bi_mmap_write),("mmap.col",bi_mmap_col),("mmap.map",bi_mmap_map),("mmap.csv",bi_mmap_csv),("read.parquet",bi_read_parquet),
