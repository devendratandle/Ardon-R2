...
pub(crate) fn base_table() -> Vec<(&'static str, BuiltinFn)> {
    vec![
        ...
        ("table",bi_table),("sapply",bi_sapply),("lapply",bi_lapply),("mapply",bi_mapply),("vapply",bi_vapply),("mclapply",bi_mclapply),("par.lapply",bi_mclapply),("par.sapply",bi_par_sapply),
        // data manipulation
