...
pub(crate) fn base_table() -> Vec<(&'static str, BuiltinFn)> {
    vec![
        ...
        ("table",bi_table),("sapply",bi_sapply),("lapply",bi_lapply),("mapply",bi_mapply),("vapply",bi_vapply),("mclapply",bi_mclapply),("par.lapply",bi_mclapply),("par.sapply",bi_par_sapply),("explain",bi_explain),
        // data manipulation
...
pub(crate) fn stats_table() -> Vec<(&'static str, BuiltinFn)> {
    vec![
        ...
        // ML functions
        ("svd",bi_svd),("eigen",bi_eigen),("prcomp",bi_prcomp),("solve",bi_solve),("det",bi_det),("backsolve",bi_backsolve),("forwardsolve",bi_forwardsolve),("rcond",bi_rcond),("kappa",bi_kappa),("mmap.write",bi_mmap_write),("mmap.col",bi_mmap_col),("mmap.map",bi_mmap_map),("mmap.csv",bi_mmap_csv),("mmap.lm",bi_mmap_lm),("read.parquet",bi_read_parquet),("mem.budget",bi_mem_budget),("mem.status",bi_mem_status),("mem.spill",bi_mem_spill),("mem.restore",bi_mem_restore),("gpu.enable",bi_gpu_enable),("gpu.status",bi_gpu_status),("gpu.map",bi_gpu_map),
        ("llm.new",bi_llm_new),("llm.train",bi_llm_train),("llm.generate",bi_llm_generate),("llm.save",bi_llm_save),("llm.load",bi_llm_load),("llm.info",bi_llm_info),("llm.free",bi_llm_free),
